...
public class Profesor extends Persona{
    ...
    //decorar tabla intermedia
    @JoinTable(
            name = "profesor_carrera",
            joinColumns = @JoinColumn(name = "profesor_id"), // tabla en la que estamos
            inverseJoinColumns = @JoinColumn(name = "carrera_id")// tabla inversa a la cual le hacemos la relacion
    )
